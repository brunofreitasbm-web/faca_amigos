...
import type { AuditLogEntry, Employee } from "../../../api/client.js";
    ...
    <div>
      <Card style={{ padding: "20px", marginBottom: "16px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "12px" }}>
          <Input label="Buscar (ação ou operador)" placeholder="ex.: CONFIG_UNIT_UPDATE, João" value={search} onChange={(e) => setSearch(e.target.value)} />
            ...
            {entries.map((entry) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "10px",
                  padding: "12px 14px",
                  cursor: entry.details_json ? "pointer" : "default",
                }}
                onClick={() => entry.details_json && setExpandedId(expandedId === entry.id ? null : entry.id)}
              >
