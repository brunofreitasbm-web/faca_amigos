            ...
            JSON.stringify(
              {
                ...
                unidades: [
                  { nome: "Playground (L-142 / PSB-1316)", apiKey: "fa_shp_playground_homolog_placeholder" },
                  { nome: "Parque Circuito (L-143 / PSB-1346)", apiKey: "fa_shp_circuito_homolog_placeholder" }
                ],
                endpoints: {
