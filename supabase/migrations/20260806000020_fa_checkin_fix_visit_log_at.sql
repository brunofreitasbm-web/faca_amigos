-- Mesma causa das duas migrations anteriores: fa_kiosk_visit_log também é
-- uma tabela-stub com uma coluna legada `at` (timestamptz) NOT NULL sem
-- default, que fa_checkin() nunca preenchia (só gravava at_ms). Passa a
-- gravar as duas.
