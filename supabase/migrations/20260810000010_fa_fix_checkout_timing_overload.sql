-- =====================================================================
-- Correção da sobrecarga de fa_kiosk_session_timing e fa_checkout
-- =====================================================================
-- Remove todas as versões anteriores de fa_kiosk_session_timing para
-- evitar o erro PostgreSQL 42725 (more than one function named
-- "fa_kiosk_session_timing") que causa HTTP 400 Bad Request ao chamar fa_checkout.

drop function if exists fa_kiosk_session_timing(record, bigint, bigint);
drop function if exists fa_kiosk_session_timing(record, bigint, bigint, bigint);
...
-- Atualização da RPC fa_checkout com chamadas explícitas de 4 parâmetros para fa_kiosk_session_timing
