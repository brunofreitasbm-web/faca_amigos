-- Correção resiliente da RPC fa_checkout para evitar HTTP 400 e erros de FK ou status
...
begin
  ...
  -- Valida se o colaborador existe na tabela; se não existir, usa o primeiro colaborador ativo
