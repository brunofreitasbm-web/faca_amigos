-- Menu Clientes do Gerencial: ordenar por número de visitas (decrescente),
-- não por data de cadastro — pedido do Owner para achar rápido quem mais
-- frequenta o parque. Empate resolvido por cadastro mais recente primeiro.
