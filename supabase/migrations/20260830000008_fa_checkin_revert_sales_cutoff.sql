-- Reverte 20260830000006_fa_checkin_sales_cutoff_15min.sql: não há mais
-- corte de 15 minutos antes do fechamento. Novos planos, pacotes e
-- entradas por banco de horas voltam a ser aceitos até o próprio horário
-- de fechamento da unidade (v_remaining <= 0), em todas as unidades,
-- Circuito e Playground — sem nenhum limite diferente do horário de
-- fechamento configurado por unidade.
