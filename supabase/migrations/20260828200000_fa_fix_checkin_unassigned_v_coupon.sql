-- Migration para corrigir erro na RPC fa_checkin: 'record "v_coupon" is not assigned yet'
-- Quando nenhum cupom era utilizado (p_coupon_code is null), o record v_coupon ficava indeterminado,
-- causando erro ao tentar ler v_coupon.kind e v_coupon.value na inserção em fa_kiosk_sessions.
